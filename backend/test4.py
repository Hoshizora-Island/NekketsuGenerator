...
#"https://api-inference.huggingface.co/models/Kwai-Kolors/Kolors"
#pip install kolors
#pip install diffusers==0.18.0.dev0



# Hugging FaceのAPI URLと認証トークン
API_URL = "https://api-inference.huggingface.co/models/Kwai-Kolors/Kolors"
